...
def hello(message: telebot.types.Message):
    bot.reply_to(message, 'Здравствуйте, чтобы начать работу с ботом нужно ввести следующую команду:\n\
<Название валюты> <В какую валюту хотите перевести> <Количество валюты>\n\
